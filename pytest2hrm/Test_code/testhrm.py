...
class Test_Orange:
    ...
    def test_upper_lower(self,booting_function):
        try:   
           ...
           print("The user should be able to see all individual menu  in upper and lower case should be displayed under search textbox")
        except NoSuchElementException:
              print('Some elements are missing !')  
              
    def test_webpage(self,booting_function):
        try:     
           self.wait.until(EC.element_to_be_clickable((By.NAME, locators.Hrm_Locators().username_inputBox)))
           self.driver.find_element(by=By.NAME, value=locators.Hrm_Locators().username_inputBox).send_keys(data.Hrm_Data().username)  
           self.wait.until(EC.element_to_be_clickable((By.NAME, locators.Hrm_Locators().password_inputBox)))
           ...
           self.wait.until(EC.element_to_be_clickable((By.XPATH, locators.Hrm_Locators().users)))
           self.driver.find_element(by=By.XPATH, value=locators.Hrm_Locators().users).click()  
    ...
    def test_new_employee(self,booting_function):
        try:
           self.wait.until(EC.element_to_be_clickable((By.NAME, locators.Hrm_Locators().username_inputBox)))
           self.driver.find_element(by=By.NAME, value=locators.Hrm_Locators().username_inputBox).send_keys(data.Hrm_Data().username) 
           self.wait.until(EC.element_to_be_clickable((By.NAME, locators.Hrm_Locators().password_inputBox)))
           ...
           self.driver.find_element(by=By.XPATH, value=locators.Hrm_Locators().confrompassword).send_keys(data.Hrm_Data().confirm_password)                                 
    ...
    def test_postuser_creation(self,booting_function):
        try:
           self.wait.until(EC.element_to_be_clickable((By.NAME, locators.Hrm_Locators().username_inputBox)))
           self.driver.find_element(by=By.NAME, value=locators.Hrm_Locators().username_inputBox).send_keys(data.Hrm_Data().username) 
           self.wait.until(EC.element_to_be_clickable((By.NAME, locators.Hrm_Locators().password_inputBox)))
    ...
    def test_employee_personal(self,booting_function):
        try:
           self.wait.until(EC.element_to_be_clickable((By.NAME, locators.Hrm_Locators().username_inputBox)))
           self.driver.find_element(by=By.NAME, value=locators.Hrm_Locators().username_inputBox).send_keys(data.Hrm_Data().username) 
           self.wait.until(EC.element_to_be_clickable((By.NAME, locators.Hrm_Locators().password_inputBox)))
           ...
           self.wait.until(EC.element_to_be_clickable((By.XPATH, locators.Hrm_Locators().militry)))
           self.driver.find_element(by=By.XPATH, value=locators.Hrm_Locators().militry).send_keys(data.Hrm_Data().militry_serives)    
    ...
    def test_contact_details(self,booting_function):
        try:
           ...
           self.wait.until(EC.element_to_be_clickable((By.XPATH, locators.Hrm_Locators().mobile)))
           self .driver.find_element(by=By.XPATH, value=locators.Hrm_Locators().mobile).send_keys(data.Hrm_Data().mobile_no)
    ...
    def test_emergency_details(self,booting_function):
        try:
           ...
           assert self.driver.title == 'OrangeHRM'
           print("The user should be able to see all the filled details present in Emerengcy contact details page")
        except NoSuchElementException:  
    ...
    def test_job_details(self,booting_function):
        try:
           ...
           print("The user should be able to see all the filled details present in job Details page")
            ...
            print('No job details are present')  
